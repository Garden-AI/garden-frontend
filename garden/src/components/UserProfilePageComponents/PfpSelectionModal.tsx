...
const PfpSelectionModal = ({ setSelectedIcon, closeModal }: PfpSelectionModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center z-50">
      <div className="p-10 rounded-lg w-1/3 bg-white h-96 overflow-auto relative">
        <div className="flex flex-row w-full">
          <h2 className="text-gray-500 text-xl mb-10">Select a Profile Picture Icon</h2>
          <X
        ...
        <div className="flex flex-wrap gap-10">
          {icons.map((iconData) => (
            <div
              ...
              className="cursor-pointer p-2 bg-primary rounded-full flex items-center justify-center w-36 h-36"
            >
              {iconData.svg}
            </div>
          ))}
