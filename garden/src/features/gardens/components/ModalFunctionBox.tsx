...
const ModalFunctionBox = ({ parentGarden, modalFunction }: { parentGarden: Garden, modalFunction: ModalFunction }) => {
  ...
  return (
    <Card
      ...
      onClick={() => navigate(`/modal-functions/${id}?parentGarden=${encodeURIComponent(parentGarden.doi)}`)}
    >
