...
export default function EntrypointTabs({ entrypoint }: { entrypoint: Entrypoint }) {
  const tabs = [
    {
      name: "Entrypoint",
      content: (entrypoint: Entrypoint) => <FunctionTab entrypoint={entrypoint} />,
    },
    {
      name: "Notebook",
      content: (entrypoint: Entrypoint) => <NotebookTab notebookURL={entrypoint.notebook_url} />,
    },
    {
      name: "Datasets",
      content: (entrypoint: Entrypoint) => <DatasetsTab datasets={entrypoint.datasets} />,
    },
  ];
  return (
