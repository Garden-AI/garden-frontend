...
const TeamsPage = () => {
  ...
  const students = [
    ...
    {
      name: "Phillip Kim",
      major: "Computer Science, Communication Design @ Washington University in St. Louis",
      ...
      <div className="bg-darkgreen py-20 text-white ">
        <div className="px-4">
          ...
          <p className="mx-auto mt-20 max-w-lg text-center">
            The people who build garden are driven by the idea that research with AI/ML should be
