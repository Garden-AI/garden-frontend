    ...
    <div className="flex flex-1 flex-col justify-between rounded-lg border border-gray-200 p-4 shadow-sm">
      ...
      <div className="">
        ...
        {member.github_link.length > 0 ? (
          ...
          >
            <img className="h-5 w-5" src="img/extern-logos/github.png" alt="github logo" />
          </a>
        ) : (
          <></>
        )}
