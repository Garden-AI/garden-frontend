...
const UserProfileShareModal = (props: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500 bg-opacity-70 font-display">
      <div className="min-h-[40vh] w-[75vw] bg-white sm:w-[50vw]">
        ...
        <div className="flex items-center justify-evenly pt-10">
          ...
          <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
            <img src="img/twitter.png" alt="Twitter logo" className="max-w-[5vw] sm:max-w-[3vw]" />
          </a>
          ...
          <a href="https://www.reddit.com/" target="_blank" rel="noopener noreferrer">
            <img src="img/reddit.png" alt="Reddit logo" className="max-w-[5vw] sm:max-w-[3vw]" />
          </a>
          <a href="https://github.com/" target="_blank" rel="noopener noreferrer">
            <img src="img/github.png" alt="Github logo" className="max-w-[5vw] sm:max-w-[3vw]" />
          </a>
          <a href="https://discord.com/" target="_blank" rel="noopener noreferrer">
            <img src="img/discord.png" alt="Discord logo" className="max-w-[5vw] sm:max-w-[3vw]" />
          </a>
        </div>
