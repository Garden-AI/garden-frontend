...
export const handlers = [
  ...
  http.get(
    "https://search.api.globus.org/v1/index/58e4df29-4492-4e7d-9317-b27eba62a911/search",
    () => {
                  ...
                  entrypoints: [
                    {
                      ...
                      papers: [
                        {
                          ...
                          citation:
                            "Hyun Park et al 2023 Mach. Learn.: Sci. Technol. 4 025036",
                        },
                      ],
                      repositories: [
                        {
                      ...
                      year: "2023",
                      base_image_uri:
                        "docker://index.docker.io/maxtuecke/garden-ai:python-3.10-jupyter-torch",
                      full_image_uri:
                        "docker://index.docker.io/willengler/dev:latest",
                      description:
